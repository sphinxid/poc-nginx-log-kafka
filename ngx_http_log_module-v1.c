...
void send_to_kafka(char *message, char *brokers, char *topic);

  static int run = 1;
  static rd_kafka_t *rk;

  char *brokers = "horton01.hd.sg-sli.adskom.net:59092";
  char *topic = "nginx-log";
    ...
    size_t len)
{
    ...
    if (log->script == NULL) {
        ...
        char *c_buf = NULL;
        c_buf = (char*) buf;
        send_to_kafka(c_buf, brokers, topic);
